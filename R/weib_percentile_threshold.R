...
#'
#' @param min_observations is the minimum vector length of dates/times of observations.
#' Vector shorter than this will return NA. Useful for especially sparse datasets.
#'
...
#' }
#'
weib_percentile_threshold <- function(observations, percentile, iterations = 500, min_observations = 20){

  # print warning if trying to estimate at a true bound, because Weibull
  # distribution cannot estimate 0th or 100th percentile

  observations <- c(t(as.matrix(observations)))
